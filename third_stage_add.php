  ...
  $getLead_id = $_GET['lead_id'];
      $msg ='<div class="alert bg-success">
           ...
           if(isset($_POST['add_third_stage'])){
                ...
                $riminder_date =  $_POST['riminder_date'];
          
             $insert_lead = "UPDATE tbl_third_lead SET Offer_status='$Offer_status',cash_status ='$cash_status',total_fee='$total_fee',paid_amount='$paid_amount',due_amount='$due_amount',riminder_date='$riminder_date',bank_stmnt='$bank_stmnt',
...
<div class="col-lg-10">
    <form action="" method="POST">
        <div class="row py-4 box_shadow">
                ...
                <div class="col-lg-2 mb-3">
                <label for="agent" class="form-label">Fees Payment
                </label>
                ...
                <div class="col-lg-2 mb-3">
                    <label for="agent" class="form-label">Reminder</label>
                    <input type="date" name="riminder_date" id="total" class="form-control">
                </div>
