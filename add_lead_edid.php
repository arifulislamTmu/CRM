           ...
           $lead_reminder = $_POST['lead_reminder'];
            ...
            $run = mysqli_query($con,$insert_msg);
              ...
              if($query){
                ...
                $insert ="UPDATE `tbl_second_lead` SET `assign_user`='$assign_user',`role`='0' WHERE lead_id = '$getLead_id'";
                $run = mysqli_query($con,$insert);

                $insert ="UPDATE `tbl_third_lead` SET `assign_user`='$assign_user',`role`='0' WHERE lead_id = '$getLead_id'";
                $run = mysqli_query($con,$insert);
