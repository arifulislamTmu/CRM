  ...
  $getLead_id = $_GET['id'];
      $msg ='<div class="alert bg-success">
           ...
           if(isset($_POST['add_third_stage'])){
             ...
             $insert_lead = "UPDATE tbl_third_lead SET Offer_status='$Offer_status',total_fee='$total_fee',paid_amount='$paid_amount',due_amount='$due_amount',cash_status ='$cash_status',bank_stmnt='$bank_stmnt',
    ...
    <form action="" method="POST">
        <div class="row py-4 box_shadow">
                ...
                <select  class="form-control" name="Offer_status" id="agent">
                   <option value="<?php echo $result['Offer_status']?>"> <?php echo $result['Offer_status']?></option>
                ...
                <option value="<?php echo $result['tuition_payment']?>"> <?php echo $result['tuition_payment']?></option>
                ...
                <div class="col-lg-2 mb-3">
                    ...
                    <input type="text" name="total_fee" id="total_free" readonly value="<?php echo $result['total_fee']?>" <?php echo $result['total_fee']?> class="form-control">
                </div>
                <div class="col-lg-2 mb-3">
                ...
                <div class="col-lg-2 mb-3">
                    ...
                    <input type="text" name="due_amount" id="total" readonly value="<?php echo $result['due_amount']?>" class="form-control">
                </div>

                <div class="col-lg-3 mb-3">
                <label for="agent" class="form-label">Pre CAS Interview</label>
                <select  class="form-control" name="pre_cas_inter" id="agent">
                <option value="<?php echo $result['pre_cas_inter']?>"> <?php echo $result['pre_cas_inter']?></option>
                ...
                <button type="submit" name="add_third_stage" class="btn btn-primary">Update</button>
                </div>
            </div>
            </form>
    </div>
