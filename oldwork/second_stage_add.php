                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <ol class="breadcrumb mb-4 py-2">
                            ...
                            <li class="breadcrumb-item active">Add Second Stage Data</li>
                        </ol>
                        <style>
                        .alert {
                        padding: 20px;
  ...
  $getLead_id = $_GET['lead_id'];
      $msg ='<div class="alert bg-success">
           ...
           if(isset($_POST['add_second_stage'])){
                ...
                $select_qur = "SELECT * FROM tbl_second_lead WHERE lead_id ='$getLead_id'";
             ...
             $insert_lead = "INSERT INTO tbl_second_lead(lead_id,skype_id,doc_list,whatsapp_id,university_name1,subject_name1,course_lavel1,agent_name,status1,university_name2,subject_name2,course_lavel2,agent_name2,status2,university_name3,subject_name3,course_lavel3,agent_name3,status3,university_name4,subject_name4,course_lavel4,agent_name4,status4)
                             VALUES('$getLead_id','$skype_id','$doc_list','$whatsapp_id','$university_name1','$subject_name1','$course_lavel1','$agent_name','$status1','$university_name2','$subject_name2','$course_lavel2','$agent_name2','$status2','$university_name3','$subject_name3','$course_lavel3','$agent_name3','$status3','$university_name4','$subject_name4','$course_lavel4','$agent_name4','$status4')";
    ...
    <form action="" method="POST">
        <div class="row py-4 box_shadow">
            <div class="col-lg-4 mb-3">
                ...
                <input type="text" name="skype_id" class="form-control" id="skype" aria-describedby="emailHelp">
                </div>
                <div class="col-lg-4 mb-3">
                <label for="WhatsApp" class="form-label">WhatsApp</label>
                <input type="text"  name="whatsapp_id" class="form-control" id="WhatsApp" aria-describedby="emailHelp">
                </div>
             
                <div class="col-lg-4 mb-3">
                    <label for="list" class="form-label">Document List</label>
                    <input type="text" name="doc_list"class="form-control" id="list" aria-describedby="emailHelp">
                </div>
        ...
        <div class="row">
                ...
                <option value="Incomplete">Select University Name </option>
                    <?php 
                      ...
                      while($rows = mysqli_fetch_array($run)){ ?>
                        <option value="<?php echo $rows['university_name']?>"><?php echo $rows['university_name']?></option>
                     <?php }
                    ?>
                </select>
                </div>
                ...
                <select  class="form-control" name="course_lavel1" id="agent">
                            <option value="Incompele">Select course</option>
                ...
                <select  class="form-control" name="agent_name" id="agent">
                    ...
                    <?php 
                      ...
                      $run = mysqli_query($con,$select);
                      while($rows = mysqli_fetch_array($run)){ ?>
                        <option value="<?php echo $rows['app_agent_name']?>"><?php echo $rows['app_agent_name']?></option>
                     <?php }
                    ?>
                </select>
                </div>
            ...
            <!-- =================hide div 5==================================
                ...
                <button type="submit" name="add_second_stage"class="btn btn-primary">Submit</button>
                </div>
            </div>
      </form>
    </div>
