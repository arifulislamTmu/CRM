                            ...
                            <div class="col-lg-10">
                                <?php 
                                  ...
                                  if(isset($_POST['subject_btn'])){
                                    ...
                                    $insert_lead = "INSERT INTO  tbl_subject(subject_name)VALUES('$subject_name')";
                                ...
                                if(isset($_REQUEST['sub_id'])){
                                    $hissen = $_GET['sub_id'];
                                    $delete = "DELETE FROM tbl_subject WHERE id='$hissen'";
                                 ...
                                 <div class="card mb-4">
                                    ...
                                    <div class="row ">
                                            ...
                                            <form action="" method="POST">
                                                ...
                                                <input class="form-control" required name="subject_name" id="inputFirstName" type="text" placeholder="Enter your first name" />
                                                  <label for="inputFirstName">Add Subject Name</label>
                                                 </div>
                                            </div>
                                            <div class="col-lg-4">
                                    ...
                                    <tbody>
                                        <?php 
                                        $cont = 1;
                                        $select_query = "SELECT * FROM tbl_subject  ORDER BY id DESC";
                                        $run = mysqli_query($con,$select_query);
                                         while($result = mysqli_fetch_array($run)){ ?>
                                        <tr>
                                            <td class="w-5"><?php echo $cont++;?></td>
                                             <td class="w-5"><?php echo $result['subject_name']?></td>
                                             <td class="w-5">
                                             <?php if($role_id=='0'){ ?>
