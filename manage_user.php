                                ...
                                <table id="datatablesSimple">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="w-5"><a class="btn btn-sm btn-success" href="edit_mage_user.php?id=<?php echo $result['id'];?>">Edit</a> <a onclick="return confirm('You are sure...?')" class="btn btn-sm btn-danger" href="?id=<?php echo $result['id']?>">Delete</a></td>
                                          </tr>
                                        <?php }
                                        ?>
