                                    ...
                                    <tbody>
                                        <?php 
                                         while($result = mysqli_fetch_array($run)){
                                            if($result['visa_status']=='VISA Success' OR $result['visa_status']=='VISA Refused' ){ ?>
                                                    <tr>
                                                        ...
                                                        <td class="w-5"><a class="btn btn-sm btn-success "href="forth_stage_edit.php?lead_id=<?php echo $result['lead_id']?> ">Add Informatin</a></td>
                                                    </tr>
