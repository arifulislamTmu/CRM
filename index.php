  ...
  <!--  -------------- Main content Start---------------------------------------->
            ...
            <div id="layoutSidenav_content">
                        ...
                        <div class="row">
                            <div class="col-xl-3 col-md-6">
                                <div class="card bg-primary text-white mb-4">
                                    <div class="card-body">Total Students ( <?php $select ="SELECT count(lead_id) AS total FROM tbl_leadform1 WHERE tbl_leadform1.assign_user='$assign_user_id' OR role='$role_id'";
                            ...
                            <div class="col-xl-3 col-md-6">
                                <div class="card  text-white mb-4" style="background-color:#6c5ce7">
                                    <div class="card-body">Applied Student ( <?php $select ="SELECT count(lead_id) AS total FROM tbl_second_lead where status1='Approved' AND tbl_second_lead.assign_user='$assign_user_id' OR role='$role_id'";
                                                                            $run = mysqli_query($con,$select);
                                                                            $value = mysqli_fetch_assoc($run);
                                                                            echo @$value['total'];
                                                                            ?> )</div>
                            ...
                            <div class="col-xl-3 col-md-6">
                                <div class="card bg-success text-white mb-4">
                                    <div class="card-body"> Visa Success ( <?php $select ="SELECT count(lead_id) AS total FROM tbl_third_lead where visa_status ='VISA Success' AND tbl_third_lead.assign_user='$assign_user_id' OR role='$role_id'";
                                                                            $run = mysqli_query($con,$select);
                                                                            $value = mysqli_fetch_assoc($run);
                                                                            echo @$value['total'];
                                                                            ?> )</div>
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <table id="datatablesSimple">
                                    ...
                                    <?php 
                                        $cont = 1;
                                         $select_query = "SELECT * FROM tbl_leadform1 WHERE tbl_leadform1.assign_user='$assign_user_id' OR tbl_leadform1.role='$role_id' ORDER BY `lead_id` DESC ";
             ...
             <div class="card my-5">
                ...
                <div class="card-body">
                    <table id="myTable" class="table  table-hover table-responsive table-striped table-bordered border" >
                        <thead>
                            <th>Sl</th>
                            <th>Student Name</th>
                            <th>Skype Id</th>
                        ...
                        <tbody>
                            <?php 
                             $coumt = '1';
                              ...
                              INNER JOIN tbl_second_lead ON tbl_leadform1.lead_id = tbl_second_lead.lead_id WHERE tbl_leadform1.assign_user='$assign_user_id' OR tbl_leadform1.role='$role_id' ORDER BY tbl_leadform1.lead_id DESC ";
                              $run = mysqli_query($con,$select);
                              while($result = mysqli_fetch_array($run)){ 
                                if($result['status1'] == 'Approved' OR $result['status2'] == 'Approved' OR $result['status3'] == 'Approved' OR $result['status3'] == 'Approved'){

                                }else{
                                    if($result['lead_status'] == 'Go for Next'){  ?>
                                        <tr>
                                        <td><?php echo $coumt++;?></td>
            ...
            <div class="card my-5">
                ...
                <div class="card-body">
                    <table id="myTable2" class="table table-responsive table-hover table-striped table-bordered border" >
                        <thead>
                           <th>Sl</th>
                           <th>Student Name</th>
                            <th>Offer Status</th>
                        ...
                        <tbody>
                            ...
                            $coumte='1';
                              ...
                              INNER JOIN tbl_second_lead ON tbl_leadform1.lead_id = tbl_second_lead.lead_id 
                               INNER JOIN tbl_third_lead ON tbl_leadform1.lead_id = tbl_third_lead.lead_id  WHERE tbl_leadform1.assign_user='$assign_user_id' OR tbl_leadform1.role='$role_id' ORDER BY tbl_leadform1.lead_id DESC ";
                              $run = mysqli_query($con,$select);
                              while($result = mysqli_fetch_array($run)){
            ...
            <div class="card my-5">
                ...
                <h5 style="color:white"><i class="fas fa-table me-1"></i> Success Student List</h5>
                </div>
                <div class="card-body">
                              ...
                              while($result = mysqli_fetch_array($run)){
                                if($result['visa_status']=='VISA Success'){ ?>
                                   <tr>
                                    ...
                                    <td><?php echo $result['tuition_payment']?></td>
                                    <td><?php echo $result['visa_status']?></td>
                                    <td><a class="btn btn-sm btn-outline-success" href="invoice_page.php?lead_id=<?php echo $result['lead_id'];?>">Invoice</a></td>
            ...
            <div class="card my-5">
                ...
                <h5 style="color:white"><i class="fas fa-table me-1"></i> Refused Student List</h5>
                </div>
                <div class="card-body">
                    <table id="myTable4" class="table table-responsive table-striped table-hover table-bordered border" >
                        <thead>
                           <th>Sl</th>
                           <th>Student Name</th>
                            <th>Offer Status</th>
                        ...
                        <tbody>
                            ...
                            $coumte='1';
                              ...
                              $run = mysqli_query($con,$select);
                              while($result = mysqli_fetch_array($run)){
                                if($result['visa_status']=='VISA Refused'){ ?>
                                   <tr>
                                     <td><?php echo $coumte++;?></td>
                                    <td><a href="all_lead_info.php?lead_id=<?php echo $result['lead_id']?>"><?php echo $result['student_name']?> &NonBreakingSpace;<i class="fas fa-external-link-alt "></i></a></td>
                                    <td><?php echo $result['Offer_status']?></td>
